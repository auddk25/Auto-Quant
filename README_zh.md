...
3. **CBBI 是最好的单一指标。** 纯 CBBI 择时（恐惧 <0.4 买入，贪婪 >0.75 卖出）实现 +289% 牛市收益 + 熊市零损失。它将多个链上指标聚合为一个信号。
...
│   │   ├── MtfTrendCbbiLead.py         # CBBI 优先 +289%
│   │   ├── MtfTrendEmaValuation.py     # 4 指标组合 +174%
...
| v0.4.0 | 98 | 0.16 (Sharpe) | CBBI/AHR999 指标 + 2026 Q1 样本外: 5/6 策略跑赢基准 |
