...
class MtfTrend08(IStrategy):
    ...
    def custom_stoploss(self, pair: str, trade, current_time, current_rate,
        ...
        # Dynamic trailing stoploss to catch large bull moves
        # In crypto, a 15-20% drop from peak is normal in a bull run.
        if current_profit >= 2.00:
            return -0.30
