"""run_combo_test.py — Compare combination strategies.

Usage: uv run run_combo_test.py
"""
...
def main():
    ...
    strategies = [
        ...
        ("MtfTrendCbbiTrendGuard", "TrendGuard (SMA200 filter)"),
        ("MtfTrendCbbiRegimeSwitch", "RegimeSwitch (bull/choppy)"),
    ]
